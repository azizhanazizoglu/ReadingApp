...
const CalibrationTopBar: React.FC<Props> = ({ host, task, darkMode, chipBorder, headerBorder, textMain, textSub, statusLabel, loadTaskSuggestions, onClear, onPush, onUpdate, onToggleLogs, showLogs, onClose, docked }) => {
  return (
